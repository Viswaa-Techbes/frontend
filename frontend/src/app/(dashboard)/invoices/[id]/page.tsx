        ...
        <div className="xl:col-span-3 space-y-6">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-8 border-b border-slate-200 py-6">
              <div>
                <h1 className="text-xl font-black text-slate-900">{document.title || 'Invoice'}</h1>
                {document.subtitle && <p className="text-xs text-slate-500 font-medium mt-1">{document.subtitle}</p>}

                <div className="mt-4 space-y-1 text-slate-650">
                  <p className="font-bold text-slate-900 uppercase text-[9px] tracking-wider mb-1">BILLED TO</p>
              ...
              <div className="text-right space-y-1.5 text-slate-650">
                <p><span className="font-bold text-slate-900">Invoice No:</span> {document.documentNumber}</p>
