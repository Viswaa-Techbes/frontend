          ...
          >
            ...
            <div className="space-y-6 flex-1">
              ...
              <div className="text-center py-4 border-b border-slate-100 print-avoid-break">
                <h1 className="text-2xl font-black text-slate-900 tracking-wide uppercase">{document.title || 'Credit Note'}</h1>
              ...
              <div className="grid grid-cols-2 gap-8 py-6 border-b border-slate-200 print-avoid-break">
                ...
                <div className="text-right space-y-1.5 text-slate-600">
                  <p className="text-xs"><span className="font-bold text-slate-900">Credit Note No:</span> {document.documentNumber}</p>
                  <p className="text-xs">
                    <span className="font-bold text-slate-900">CN Date:</span>{' '}
                    {new Date(document.issueDate).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}
                  </p>
                  <p className="text-xs"><span className="font-bold text-slate-900">Reason:</span> {getReasonLabel(document.reason)}</p>
                  {document.linkedInvoiceSnapshot?.documentNumber && (
                    <p className="text-xs"><span className="font-bold text-slate-900">Linked Invoice:</span> {document.linkedInvoiceSnapshot.documentNumber}</p>
                  )}
