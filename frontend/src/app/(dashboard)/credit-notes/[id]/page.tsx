          ...
          >
            ...
            <div className="invoice-doc-header print-avoid-break">
              ...
              <div className="invoice-doc-meta">
                <h1 className="invoice-doc-title">{document.title || 'Credit Note'}</h1>
                ...
                <div className="invoice-doc-meta-grid">
                  <div className="invoice-doc-meta-row">
                    <span className="invoice-doc-meta-label">Credit Note No</span>
                    <span className="invoice-doc-meta-value">{document.documentNumber}</span>
                  </div>
                  <div className="invoice-doc-meta-row">
                    <span className="invoice-doc-meta-label">CN Date</span>
            ...
            <div className="invoice-doc-section print-avoid-break">
              <div className="invoice-doc-parties">
                <div className="invoice-doc-party-box">
                  <p className="invoice-doc-section-label">Issued To</p>
                ...
                <div className="invoice-doc-party-box invoice-doc-party-box--white">
                  ...
                  <div className="invoice-doc-detail-row">
                    <span className="invoice-doc-detail-label">Credit Note No</span>
                    <span className="invoice-doc-detail-value">{document.documentNumber}</span>
                  </div>
                  <div className="invoice-doc-detail-row">
                    <span className="invoice-doc-detail-label">Reason</span>
                    <span className="invoice-doc-detail-value">{getReasonLabel(document.reason)}</span>
                  </div>
                  {document.linkedInvoiceSnapshot?.documentNumber && (
                    <div className="invoice-doc-detail-row">
                      <span className="invoice-doc-detail-label">Linked Invoice</span>
                      <span className="invoice-doc-detail-value">{document.linkedInvoiceSnapshot.documentNumber}</span>
                    </div>
                  )}
